...
export type GenericMorph = I18NLocale | Page | Test | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type Test = {
  __typename?: 'Test';
  createdAt?: Maybe<Scalars['DateTime']>;
  img: UploadFileRelationResponseCollection;
  publishedAt?: Maybe<Scalars['DateTime']>;
  title?: Maybe<Scalars['String']>;
  updatedAt?: Maybe<Scalars['DateTime']>;
};
...
export const TestsDocument = gql`
  ...
  export class TestsGQL extends Apollo.Query<TestsQuery, TestsQueryVariables> {
